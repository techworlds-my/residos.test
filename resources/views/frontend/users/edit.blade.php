                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_credit" id="total_credit" value="{{ old('total_credit', $user->total_credit) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="current_credit" id="current_credit" value="{{ old('current_credit', $user->current_credit) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_point" id="total_point" value="{{ old('total_point', $user->total_point) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="current_point" id="current_point" value="{{ old('current_point', $user->current_point) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ic_number" id="ic_number" value="{{ old('ic_number', $user->ic_number) }}">
