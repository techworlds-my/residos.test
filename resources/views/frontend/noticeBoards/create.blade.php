    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.notice-boards.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="post_at" id="post_at" value="{{ old('post_at') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_to" id="post_to" value="{{ old('post_to', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="pinned" id="pinned" value="{{ old('pinned', '0') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_by" id="post_by" value="{{ old('post_by', '') }}">
