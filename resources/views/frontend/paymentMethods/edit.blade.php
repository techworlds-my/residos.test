                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payment-methods.update", [$paymentMethod->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="method" id="method" value="{{ old('method', $paymentMethod->method) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $paymentMethod->status) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $paymentMethod->description) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="in_enable" id="in_enable" value="1" {{ $paymentMethod->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }} required>
