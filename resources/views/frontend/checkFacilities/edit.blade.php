    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.check-facilities.update", [$checkFacility->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $checkFacility->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="date_time" id="date_time" value="{{ old('date_time', $checkFacility->date_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="defect_id" id="defect_id">
