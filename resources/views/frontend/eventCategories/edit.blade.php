                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.event-categories.update", [$eventCategory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cateogey" id="cateogey" value="{{ old('cateogey', $eventCategory->cateogey) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="is_enable" id="is_enable" value="1" {{ $eventCategory->is_enable || old('is_enable', 0) === 1 ? 'checked' : '' }} required>
