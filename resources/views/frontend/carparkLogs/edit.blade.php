    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.carpark-logs.update", [$carparkLog->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="time_in">{{ trans('cruds.carparkLog.fields.time_in') }}</label>
                            <input class="form-control" type="text" name="time_in" id="time_in" value="{{ old('time_in', $carparkLog->time_in) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="time_out" id="time_out" value="{{ old('time_out', $carparkLog->time_out) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $carparkLog->price) }}" step="1">
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="carplate_id" id="carplate_id" required>
