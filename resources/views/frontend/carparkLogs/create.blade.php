    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.carpark-logs.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="time_in">{{ trans('cruds.carparkLog.fields.time_in') }}</label>
                            <input class="form-control" type="text" name="time_in" id="time_in" value="{{ old('time_in', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="time_out" id="time_out" value="{{ old('time_out', '') }}">
