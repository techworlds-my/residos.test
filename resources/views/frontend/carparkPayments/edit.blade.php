    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.carpark-payments.update", [$carparkPayment->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="carplate">{{ trans('cruds.carparkPayment.fields.carplate') }}</label>
                            <input class="form-control" type="text" name="carplate" id="carplate" value="{{ old('carplate', $carparkPayment->carplate) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="payment" id="payment" value="{{ old('payment', $carparkPayment->payment) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_method" id="payment_method" value="{{ old('payment_method', $carparkPayment->payment_method) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remark" id="remark" value="{{ old('remark', $carparkPayment->remark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $carparkPayment->status) }}" required>
