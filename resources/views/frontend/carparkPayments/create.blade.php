    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.carpark-payments.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="carplate">{{ trans('cruds.carparkPayment.fields.carplate') }}</label>
                            <input class="form-control" type="text" name="carplate" id="carplate" value="{{ old('carplate', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="payment" id="payment" value="{{ old('payment', '') }}" step="1" required>
