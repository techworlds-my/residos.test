    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.status-controls.update", [$statusControl->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="status">{{ trans('cruds.statusControl.fields.status') }}</label>
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $statusControl->status) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="desctiption" id="desctiption" value="{{ old('desctiption', $statusControl->desctiption) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="in_enable" id="in_enable" value="1" {{ $statusControl->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }} required>
