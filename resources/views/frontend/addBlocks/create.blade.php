    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.add-blocks.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="block">{{ trans('cruds.addBlock.fields.block') }}</label>
                            <input class="form-control" type="text" name="block" id="block" value="{{ old('block', '') }}" required>
                            @if($errors->has('block'))
