    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.defact-categories.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="defact_category">{{ trans('cruds.defactCategory.fields.defact_category') }}</label>
                            <input class="form-control" type="text" name="defact_category" id="defact_category" value="{{ old('defact_category', '') }}" required>
