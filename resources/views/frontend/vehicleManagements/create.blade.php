                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vehicle-managements.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="modal" id="modal" value="{{ old('modal', '') }}">
                            @if($errors->has('modal'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('modal') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="is_season_park" id="is_season_park" value="1" required {{ old('is_season_park', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="is_resident" id="is_resident" value="1" required {{ old('is_resident', 0) == 1 ? 'checked' : '' }}>
