    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.add-units.update", [$addUnit->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="unit">{{ trans('cruds.addUnit.fields.unit') }}</label>
                            <input class="form-control" type="text" name="unit" id="unit" value="{{ old('unit', $addUnit->unit) }}" required>
                            @if($errors->has('unit'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="floor" id="floor" value="{{ old('floor', $addUnit->floor) }}" required>
                            @if($errors->has('floor'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('floor') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="unit_square" id="unit_square" value="{{ old('unit_square', $addUnit->unit_square) }}" step="0.01" required>
