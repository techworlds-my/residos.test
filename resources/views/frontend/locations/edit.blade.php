                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.locations.update", [$location->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $location->location) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_enable" id="in_enable" value="1" {{ $location->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }}>
