    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.entrances.update", [$entrance->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.entrance.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $entrance->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_active" id="last_active" value="{{ old('last_active', $entrance->last_active) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_enable" id="in_enable" value="1" {{ $entrance->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }}>
