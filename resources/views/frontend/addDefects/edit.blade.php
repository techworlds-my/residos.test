    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.add-defects.update", [$addDefect->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="defect">{{ trans('cruds.addDefect.fields.defect') }}</label>
                            <input class="form-control" type="text" name="defect" id="defect" value="{{ old('defect', $addDefect->defect) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="available_date" id="available_date" value="{{ old('available_date', $addDefect->available_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="available_time" id="available_time" value="{{ old('available_time', $addDefect->available_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remark" id="remark" value="{{ old('remark', $addDefect->remark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="inchargeperson_id" id="inchargeperson_id">
