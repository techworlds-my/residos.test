    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.add-defects.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="defect">{{ trans('cruds.addDefect.fields.defect') }}</label>
                            <input class="form-control" type="text" name="defect" id="defect" value="{{ old('defect', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="available_date" id="available_date" value="{{ old('available_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="available_time" id="available_time" value="{{ old('available_time') }}" required>
