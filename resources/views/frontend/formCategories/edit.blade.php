    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.form-categories.update", [$formCategory->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="category">{{ trans('cruds.formCategory.fields.category') }}</label>
                            <input class="form-control" type="text" name="category" id="category" value="{{ old('category', $formCategory->category) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_enable" id="in_enable" value="1" {{ $formCategory->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }}>
