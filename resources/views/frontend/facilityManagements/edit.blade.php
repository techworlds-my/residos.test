    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.facility-managements.update", [$facilityManagement->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="desctiption">{{ trans('cruds.facilityManagement.fields.desctiption') }}</label>
                            <textarea class="form-control ckeditor" name="desctiption" id="desctiption">{!! old('desctiption', $facilityManagement->desctiption) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $facilityManagement->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="open" id="open" value="{{ old('open', $facilityManagement->open) }}" required>
                            @if($errors->has('open'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('open') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="closed" id="closed" value="{{ old('closed', $facilityManagement->closed) }}" required>
