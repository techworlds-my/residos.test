...
@can('vehicle_brand_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.vehicle-brands.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-VehicleBrand">
            <thead>
                <tr>
                    <th width="10">
...
@can('vehicle_brand_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.vehicle-brands.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.vehicle-brands.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-VehicleBrand').DataTable(dtOverrideGlobals);
