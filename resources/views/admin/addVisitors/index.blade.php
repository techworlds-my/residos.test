...
@can('add_visitor_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.add-visitors.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AddVisitor">
            <thead>
                <tr>
                    <th width="10">
...
@can('add_visitor_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.add-visitors.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.add-visitors.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'status', name: 'status' },
{ data: 'username_username', name: 'username.username' },
{ data: 'add_by_username', name: 'add_by.username' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AddVisitor').DataTable(dtOverrideGlobals);
