...
@can('carpark_location_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.carpark-locations.create') }}">
...
@can('carpark_location_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.carpark-locations.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.carpark-locations.index') }}",
    columns: [
