    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.notice-boards.update", [$noticeBoard->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content" required>{{ old('content', $noticeBoard->content) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('post_at') ? 'is-invalid' : '' }}" type="text" name="post_at" id="post_at" value="{{ old('post_at', $noticeBoard->post_at) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_to') ? 'is-invalid' : '' }}" type="text" name="post_to" id="post_to" value="{{ old('post_to', $noticeBoard->post_to) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pinned') ? 'is-invalid' : '' }}" type="number" name="pinned" id="pinned" value="{{ old('pinned', $noticeBoard->pinned) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $noticeBoard->status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_by') ? 'is-invalid' : '' }}" type="text" name="post_by" id="post_by" value="{{ old('post_by', $noticeBoard->post_by) }}">
