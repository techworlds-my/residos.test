...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.addDefect.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.add-defects.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="defect">{{ trans('cruds.addDefect.fields.defect') }}</label>
                <input class="form-control {{ $errors->has('defect') ? 'is-invalid' : '' }}" type="text" name="defect" id="defect" value="{{ old('defect', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('available_date') ? 'is-invalid' : '' }}" type="text" name="available_date" id="available_date" value="{{ old('available_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('available_time') ? 'is-invalid' : '' }}" type="text" name="available_time" id="available_time" value="{{ old('available_time') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('inchargeperson') ? 'is-invalid' : '' }}" name="inchargeperson_id" id="inchargeperson_id">
                    @foreach($inchargepeople as $id => $inchargeperson)
                        <option value="{{ $id }}" {{ old('inchargeperson_id') == $id ? 'selected' : '' }}>{{ $inchargeperson }}</option>
                    @endforeach
                </select>
