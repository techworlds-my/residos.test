...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.status-controls.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desctiption') ? 'is-invalid' : '' }}" type="text" name="desctiption" id="desctiption" value="{{ old('desctiption', '') }}" required>
