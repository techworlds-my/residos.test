...
@can('add_tanent_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.add-tanents.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AddTanent">
            <thead>
                <tr>
                    <th width="10">
...
@can('add_tanent_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.add-tanents.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.add-tanents.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'unit_unit', name: 'unit.unit' },
{ data: 'tanent_name', name: 'tanent.name' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AddTanent').DataTable(dtOverrideGlobals);
