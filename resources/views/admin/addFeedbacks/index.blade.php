...
@can('add_feedback_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.add-feedbacks.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AddFeedback">
            <thead>
                <tr>
                    <th width="10">
...
@can('add_feedback_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.add-feedbacks.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.add-feedbacks.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AddFeedback').DataTable(dtOverrideGlobals);
