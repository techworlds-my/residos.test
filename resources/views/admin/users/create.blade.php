    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_credit') ? 'is-invalid' : '' }}" type="number" name="total_credit" id="total_credit" value="{{ old('total_credit', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_credit') ? 'is-invalid' : '' }}" type="number" name="current_credit" id="current_credit" value="{{ old('current_credit', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_point') ? 'is-invalid' : '' }}" type="number" name="total_point" id="total_point" value="{{ old('total_point', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_point') ? 'is-invalid' : '' }}" type="number" name="current_point" id="current_point" value="{{ old('current_point', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ic_number') ? 'is-invalid' : '' }}" type="text" name="ic_number" id="ic_number" value="{{ old('ic_number', '') }}">
